...
def parse_args():
    parser = argparse.ArgumentParser(description="Run GDMMRec.")
    # 模型和数据集选择
    parser.add_argument('--Model', nargs='?', default='GDMMRec', help='Model name')
    # 数据集：baby,clothing,sports,beauty
    parser.add_argument('--data_path', nargs='?', default='baby', help='Input data path.')
    # 超参数选择
    ...
    parser.add_argument('--align_weight', type=int, default=0.1, help='MENTOR align_weight')
    parser.add_argument('--mask_weight_f', type=int, default=1.5, help='MENTOR mask_weight_f')
    parser.add_argument('--mask_weight_g', type=int, default=0.001, help='MENTOR mask_weight_g')
    # 一些默认参数
